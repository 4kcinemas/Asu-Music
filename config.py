...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Namma_Pasanga_Tamil_Chating")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AboutSarathi")
STRING_SESSION = getenv("STRING_SESSION", None)
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1217260904").split()))
